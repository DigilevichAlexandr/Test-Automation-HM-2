...
namespace WebDriverDemo
{
    public class FirstTest
    {
        ...
        public void MainTestFirst()
        {
            ...
            try
            {
                IWebElement seniorText = driver.FindElement(By.XPath("//*[contains(text(), 'Senior')]"));
                seniorText.Click();
            }
            catch (NoSuchElementException)
            {
                IWebElement firstPick = driver.FindElement(By.XPath("//div[@class='position-name hot']/a[1]"));
                firstPick.Click();
            }
            finally
            {
